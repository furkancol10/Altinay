        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumberOfPersonel = table.Column<int>(type: "integer", nullable: false),
                    RequestDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    RequestReason = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: true),
                    RequestType = table.Column<int>(type: "integer", nullable: false),
                    ReplacementPersonName = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
                    ReasonForLeaving = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: true),
                    LeavingDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    ReasonForNewPosition = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: true),
                    MinAge = table.Column<int>(type: "integer", nullable: false),
                    MaxAge = table.Column<int>(type: "integer", nullable: false),
                    Gender = table.Column<int>(type: "integer", maxLength: 128, nullable: false),
                    Location = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false),
                    ExperienceStatus = table.Column<int>(type: "integer", nullable: false),
                    OtherQualifications = table.Column<List<string>>(type: "text[]", maxLength: 256, nullable: false),
                    SuggestedPersonelName = table.Column<string>(type: "text", nullable: true),
                    SuggestedJobTitle = table.Column<string>(type: "text", nullable: true),
                    ReasonForSuggestion = table.Column<string>(type: "text", nullable: true),
                    RequesterName = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
                    RequesterTitle = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppPersonelRequest", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppBooking", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Availibility = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_AppBooking_AppRoom_RoomID",
                schema: "Altinay",
                table: "AppBooking",
                column: "RoomID",
                principalSchema: "Altinay",
